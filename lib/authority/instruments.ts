...
const CAUTION_DELEGATED =
  "스스로 결정하기 어려운 상태에서 한 행위는 나중에 효력을 두고 다툼이 생길 수 있어요. 보호자나 법에서 정한 청구권자가 대신 진행해야 해요.";

const CAUTION_DECLINING =
  "판단에 어려움이 보이기 시작한 시기예요. 이때 한 행위는 나중에 다툼이 생길 수 있어서, 보통 전문의 소견서를 함께 받아 둬요.";
...
const TRUST_STEPS: AuthorityStep[] = [
  {
    ...
    by: "본인",
    detail: "의뢰서의 조항 초안과 아직 못 정한 항목을 함께 전달해요.",
  },
  {
    n: 2,
    label: "신탁회사·법무법인이 검토하고 계약 체결",
    by: "전문가",
    detail:
      "조항이 유효한지, 세금은 어떻게 되는지, 기관별 최소 금액은 얼마인지 확인한 뒤 계약서를 써요.",
  },
  {
    n: 3,
    label: "신탁재산 이전",
    by: "금융기관",
    detail:
      "금융자산은 신탁계좌로 옮기고, 부동산은 신탁등기를 마쳐야 해요. 이전이 끝나야 신탁이 움직여요.",
  },
];
...
const MANDATE_STEPS: AuthorityStep[] = [
  {
    ...
    by: "본인",
    detail: "지출설계서 제2조의 자동이체 목록을 그대로 옮겨 적어요.",
  },
  {
    n: 2,
    ...
    by: "금융기관",
    detail:
      "본인이 직접 처리하기 어려워졌을 때 지정한 사람이 대신하려면 미리 등록해야 해요.",
  },
];
